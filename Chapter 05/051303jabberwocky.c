/**Applications of Chapter 5, Section 13, Exercise 3 of Horowitz's Data Structures
 * in C. The input file has now changed from the Gettysburg Address to Jabberwocky.
 */
...
int main() {
    ...
    if ((file = fopen("jabberwocky.txt", "r")) == NULL) {
